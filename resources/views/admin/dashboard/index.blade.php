...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="fs-16 mb-1">Demi Box v 3.0</h4>

                    <p class="text-muted mb-0">Vitajte vo Vašej administrácii</p>
                </div>
            </div>

            <div class="row">
                <div class="col-sm-12">
                    <h4 class="fs-16 mb-1">Úvod</h4>
            ...
            <h4 class="fs-16 mb-1">Potrebujete pomoc?</h4>
